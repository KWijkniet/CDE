...
// rw = rectangle Width
// rh = rectangle Height
function pointRectangle(px, py, rx, ry, rw, rh){
...
function RectangleRectangle(r1x, r1y, r1w, r1h, r2x, r2y, r2w, r2h){
...
// rw = rectangle Width
// rh = rectangle Height
function circleRectangle(cx, cy, cr, rx, ry, rw, rh){
    var testX = cx;
    var testY = cy;
...
// cy = circle Y
// cr = circle Radius
function polygonCircle(vertices, cx, cy, cr){
    //loop over all vertices
    var next = 0;
    for (let current = 0; current < vertices.length; current++) {
...
// rw = rectangle Width
// rh = rectangle Height
function polygonRectangle(vertices, rx, ry, rw, rh){
    //loop over all vertices
    var next = 0;
    for (let current = 0; current < vertices.length; current++) {
...
// x2 = line X of the ending point
// y2 = line Y of the ending point
function polygonLine(vertices, x1, y1, x2, y2){
    //loop over all vertices
    var next = 0;
    for (let current = 0; current < vertices.length; current++) {
...
// px = point X
// py = point Y
function trianglePoint(x1, y1, x2, y2, x3, y3, px, py){
