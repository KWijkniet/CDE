...
(function(global, factory) {
  ...
  var _mousedown, _mousemoved, _lastPos, _offset, _bonusSize, _state, _type, _colors, _margin, _renderer, _cursor, _ruler, _button, _buttonAllowed, _buttonForbidden, _menu, _callCancel, _state2, _type2, _shape, _originalShowData, _verticeIndex, _colors2, _margin2, _renderer2, _cursor2, _callStart, _callEnd, _callCancel2, _dropdown, _dropdownMenu, _editButton, _addButton, _removeButton, _pos, _oldPos, _buffer, _textBuffer, _cursor3, _margin3, _generateUniqSerial, generateUniqSerial_fn, _shapes, _length, _cursor4;
  "use strict";
  class Vector2$1 {
    constructor(_x, _y) {
  ...
  class Grid {
    constructor(size, maxWidth, maxHeight, color = new color(255, 255, 255), bonusSize2) {
      __publicField(this, "size", 0);
      __publicField(this, "coords", []);
      __publicField(this, "buffer", null);
      __publicField(this, "bonusSize", 0);
      this.size = size;
      this.bonusSize = bonusSize2;
      this.buffer = createGraphics(maxWidth + bonusSize2 * 2, maxHeight + bonusSize2 * 2);
      this.buffer.canvas.id = "GridBufferGraphics";
      var xAmount = Math.ceil((maxWidth + bonusSize2 * 2) / this.size);
      var yAmount = Math.ceil((maxHeight + bonusSize2 * 2) / this.size);
  ...
  class Cursor {
    constructor(grid, canvas, track = true, margin2 = 0, bonusSize2 = 0) {
      __publicField(this, "grid", null);
      __publicField(this, "visualize", false);
      __publicField(this, "track", false);
      ...
      __privateAdd(this, _bonusSize, 0);
      this.track = track;
      this.grid = grid;
      this.canvas = canvas;
      __privateSet(this, _bonusSize, bonusSize2);
    ...
    drag(e, type) {
      ...
      if (e.target.tagName == "CANVAS") {
        if (e.shiftKey && this.diff != null && newPos != null) {
          __privateGet(this, _offset).add(this.diff).minMax(new Vector2(-__privateGet(this, _bonusSize), -__privateGet(this, _bonusSize)), new Vector2(__privateGet(this, _bonusSize), __privateGet(this, _bonusSize)));
          __privateSet(this, _lastPos, new Vector2(newPos.x, newPos.y));
        } else {
          this.diff = null;
        }
  ...
  class Shape$1 {
    ...
    update() {
      ...
      image(__privateGet(this, _buffer), __privateGet(this, _pos).x + offset.x + __privateGet(this, _margin3) / 2, __privateGet(this, _pos).y + offset.y + __privateGet(this, _margin3) / 2);
    }
    updateText() {
      var offset = __privateGet(this, _cursor3).getOffset();
    ...
    generate() {
      if (__privateGet(this, _buffer) != null) {
        __privateGet(this, _buffer).elt.parentNode.removeChild(__privateGet(this, _buffer).elt);
      ...
      if (__privateGet(this, _buffer) == null) {
        __privateSet(this, _buffer, createGraphics(width, height));
        __privateGet(this, _buffer).canvas.id = "ShapesBufferGraphics_" + __privateMethod(this, _generateUniqSerial, generateUniqSerial_fn).call(this);
        __privateSet(this, _textBuffer, createGraphics(width, height));
        __privateGet(this, _textBuffer).canvas.id = "TEXT_" + __privateGet(this, _buffer).canvas.id;
      }
      this.generateShape();
      this.generateInfo();
    }
    generateShape() {
      __privateGet(this, _buffer).beginShape();
      for (let i = 0; i < this.vertices.length; i++) {
        const vc = this.vertices[i];
        __privateGet(this, _buffer).vertex(vc.x - __privateGet(this, _pos).x, vc.y - __privateGet(this, _pos).y);
      }
      __privateGet(this, _buffer).fill(this.color.r, this.color.g, this.color.b);
      __privateGet(this, _buffer).vertex(this.vertices[0].x - __privateGet(this, _pos).x, this.vertices[0].y - __privateGet(this, _pos).y);
      __privateGet(this, _buffer).endShape(CLOSE);
    }
    generateInfo() {
      if (this.showData) {
        var next = 0;
  ...
  class Renderer {
    constructor(cursor) {
      ...
      __privateAdd(this, _cursor4, null);
